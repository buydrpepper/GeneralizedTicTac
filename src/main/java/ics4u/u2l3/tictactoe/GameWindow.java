...
public class GameWindow extends javax.swing.JFrame {
	...
	private void initCustomComponents() { 
		try {
			...
			imageXWin = ImageIO.read(new File("xw.png")); 
			imageOWin = ImageIO.read(new File("ow.png")); 
			imageXTie = ImageIO.read(new File("xt.png")); 
			imageOTie = ImageIO.read(new File("ot.png")); 
			imageDefault = ImageIO.read(new File("def.png")); 
